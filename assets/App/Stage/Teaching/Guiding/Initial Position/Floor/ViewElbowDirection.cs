...
public class ViewElbowDirection : MonoBehaviour {
    ...
    void Update() {
        float directionDiff = currentDirection.x - targetDirection.x;
        //Debug.Log(directionDiff);
        this.dottedCircle.localPosition = new Vector3(directionDiff, this.dottedCircle.localPosition.y, this.dottedCircle.localPosition.z);
